...
class Generator:
    def __init__(self, model_name: str = "gpt-4o-mini"):
        """
        Initializes the OpenAI-based LLM and the retriever.
        """
        # Load your Retriever
    ...
    def ask(self, query: str, top_k: int = 10) -> str:
        """
        Uses retriever to find context and OpenAI to generate an answer.
        """
        ...
        messages = [
            SystemMessage(
                content=(
                    # Instruction
                    "You are a traffic law assistant trained on Indian traffic rules and regulations. "
                    ...
                    # Goal
                    "Help users understand their rights, duties, and consequences as per Indian road traffic laws, using only the source material."
                )
            ),
            HumanMessage(
                content=f"Context:\n{context}\n\nQuestion: {query}"
        ...
        # Generate and return answer from OpenAI LLM
